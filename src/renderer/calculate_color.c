...
/*   Updated: 2025/03/01 18:06:52 by jorvarea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_wall_hit determine_wall_direction(int hit_side, double ray_direction[2], double position[2])
{
    t_wall_hit wall_hit;
...
void calculate_wall_info(t_game *game, double angle_offset, t_wall_info *wall)
{
    double dx;
    double dy;
