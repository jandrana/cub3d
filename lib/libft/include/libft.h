...
/**
 * @brief Checks if the string passed as argument is composed of letters or not
 *
 * @details In ascii, the following characters are considered
 * letters by their int values: 97-122 and 65-90 (included)
 * @param str string
 * @return Int: (1) when str is only composed of letters
...
/**
 * @brief Checks if the string passed as argument is composed of digits or not
 *
 * @details In ascii, the following characters are considered
 * digit by their int values: 48-57 (included)
 * @param str string
 * @return Int: (1) when str is only composed of digits
 * and (0) when it is not
 */
...
/**
 * @brief Checks if the string passed as argument is composed of printable
 * characters or not
 *
 * @details In ascii, the following characters are considered
 * printable by their int values: 32-126 (included)
 * @param str string
 * @return Int: (1) when str is composed only of printable characters
 * and (0) when it is not
 */
 ...
 * long representation
 * @param str string to convert
 * @return returns the long representation of the initial portion of str
 */
